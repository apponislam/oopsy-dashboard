...
import { X, Wallet, Building2, Calendar, CreditCard, Tag } from "lucide-react";
...
export function PayoutDetailsModal({ payout, onClose }: PayoutDetailsModalProps) {
            ...
            <div className="bg-white rounded-2xl border border-[#005461]/20 shadow-xl max-w-md w-full overflow-hidden">
                ...
                <div className="p-5 bg-[#f0f9fa] border-b border-[#005461]/10 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="text-base font-bold text-[#005461]">Payout Details</h3>
                ...
                <div className="p-6 space-y-4 text-xs">
                    <div className="grid grid-cols-2 gap-3">
                        <div className="p-3 rounded-xl bg-[#f0f9fa] border border-[#005461]/5 flex flex-col gap-1">
                            <span className="text-[10px] uppercase font-bold text-[#005461]/60 flex items-center gap-1">
                                <Building2 className="w-3 h-3 text-[#005461]" /> Provider Name
                            </span>
                            <span className="font-bold text-[#005461]">{payout.provider}</span>
                        </div>

                        <div className="p-3 rounded-xl bg-[#f0f9fa] border border-[#005461]/5 flex flex-col gap-1">
                            <span className="text-[10px] uppercase font-bold text-[#005461]/60 flex items-center gap-1">
                                <Wallet className="w-3 h-3 text-[#005461]" /> Payout Amount
                            </span>
                            <span className="font-extrabold text-[#005461]">{payout.amount}</span>
                        </div>
                    </div>
                    ...
                    <div className="p-3 rounded-xl bg-[#f0f9fa] border border-[#005461]/5 flex items-center justify-between">
                        <span className="font-semibold text-[#005461]/70 flex items-center gap-1">
                            <Calendar className="w-3.5 h-3.5 text-[#005461]" /> Billing Period
                        </span>
                        <span className="font-bold text-[#005461]">{payout.period}</span>
                    </div>

                    <div className="p-3 rounded-xl bg-[#f0f9fa] border border-[#005461]/5 flex items-center justify-between">
                        <span className="font-semibold text-[#005461]/70 flex items-center gap-1">
                            <CreditCard className="w-3.5 h-3.5 text-[#005461]" /> Bank Account
                        </span>
                        <span className="font-bold text-[#005461]">{payout.bank}</span>
                    </div>

                    <div className="p-3 rounded-xl bg-[#f0f9fa] border border-[#005461]/5 flex items-center justify-between">
                        <span className="font-semibold text-[#005461]/70 flex items-center gap-1">
                            <Tag className="w-3.5 h-3.5 text-[#005461]" /> Transfer Status
                        </span>
                        <span
